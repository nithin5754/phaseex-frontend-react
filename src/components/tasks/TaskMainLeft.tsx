...
import { selectOpenTaskDesc, setOpenDescTask } from "@/app/redux/slice/taskSlice"
  ...
  return (
    <div>
     ...
     {!openDescTask&&(<>
      ...
      <div className="flex p-4 bg-white border dark:border-border rounded-lg dark:bg-background dark:text-primary">
...
>
  ...
  {singleTask&&singleTask.taskLink.length>0&&<TaskLinks links={singleTask?.taskLink}/>}
    ...
    <Button onClick={()=>dispatch(setOpenDescTask(false))}>close</Button>

...
interface OpenModalProps{
  ...
  export  function TaskLinkModal({icon:Icon,spaceId,folderId,listId,taskId}:OpenModalProps) {
  ...
  return (
    ...
    <Button> <Icon size={14} /> Link</Button>
    
    </DialogTrigger>
    <DialogContent className="sm:max-w-[425px]  dark:border-border dark:border ">
      <DialogHeader>
        <DialogTitle className="dark:text-primary text-white w-full text-center font-thin"> Add link to the task</DialogTitle>

...
interface OpenModalProps{
  ...
  export  function TodoCollabModal({icon:Icon,spaceId,folderId,listId,taskId,todoId}:OpenModalProps) {
  ...
  return (
    ...
    <CollabTodo workspaceId={spaceId} folderId={folderId} listId={listId} taskId={taskId} todoId={todoId}/>
